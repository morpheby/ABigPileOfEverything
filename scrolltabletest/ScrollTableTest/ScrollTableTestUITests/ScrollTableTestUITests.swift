...
class ScrollTableTestUITests: XCTestCase {
    ...
    func testCellFoundByLabel_visible() {
        application.cells.staticTexts["Cell 2"].tap()
    }

    func testCellFoundByLabel_invisible() {
        application.cells.staticTexts["Cell 199"].tap()
    }
    ...
    func testCustomCellFoundByLabel_invisible_id() {
        application.cells.staticTexts["custom.cell.199"].tap()
    }
    ...
    func testCustomCellFoundByAccessibilityLabel_invisible() {
